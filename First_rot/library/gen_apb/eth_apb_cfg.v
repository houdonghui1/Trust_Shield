...
assign r1_top_ctrl_wr = (paddr == 32'h40020000 + 8'h30) & reg_wr;
assign r1_top_ctrl_rd = (paddr == 32'h40020000 + 8'h30) & reg_rd;
assign r1_dma_ctrl0_wr = (paddr == 32'h40020000 + 8'h34) & reg_wr;
assign r1_dma_ctrl0_rd = (paddr == 32'h40020000 + 8'h34) & reg_rd;
assign r1_dma_tdes0_wr = (paddr == 32'h40020000 + 8'h40) & reg_wr;
assign r1_dma_tdes0_rd = (paddr == 32'h40020000 + 8'h40) & reg_rd;
assign r1_dma_tdes1_wr = (paddr == 32'h40020000 + 8'h44) & reg_wr;
assign r1_dma_tdes1_rd = (paddr == 32'h40020000 + 8'h44) & reg_rd;
assign r1_dma_tdes2_wr = (paddr == 32'h40020000 + 8'h48) & reg_wr;
assign r1_dma_tdes2_rd = (paddr == 32'h40020000 + 8'h48) & reg_rd;
assign r1_dma_rdes0_wr = (paddr == 32'h40020000 + 8'h50) & reg_wr;
assign r1_dma_rdes0_rd = (paddr == 32'h40020000 + 8'h50) & reg_rd;
assign r1_dma_rdes1_wr = (paddr == 32'h40020000 + 8'h54) & reg_wr;
assign r1_dma_rdes1_rd = (paddr == 32'h40020000 + 8'h54) & reg_rd;
assign r1_dma_rdes2_wr = (paddr == 32'h40020000 + 8'h58) & reg_wr;
assign r1_dma_rdes2_rd = (paddr == 32'h40020000 + 8'h58) & reg_rd;
assign r1_tdes00_wr = (paddr == 32'h40020000 + 8'h80) & reg_wr;
assign r1_tdes00_rd = (paddr == 32'h40020000 + 8'h80) & reg_rd;
assign r1_tdes01_wr = (paddr == 32'h40020000 + 8'h84) & reg_wr;
assign r1_tdes01_rd = (paddr == 32'h40020000 + 8'h84) & reg_rd;
assign r1_tdes02_wr = (paddr == 32'h40020000 + 8'h88) & reg_wr;
assign r1_tdes02_rd = (paddr == 32'h40020000 + 8'h88) & reg_rd;
assign r1_tdes03_wr = (paddr == 32'h40020000 + 8'h8c) & reg_wr;
assign r1_tdes03_rd = (paddr == 32'h40020000 + 8'h8c) & reg_rd;
assign r1_tdes10_wr = (paddr == 32'h40020000 + 8'h90) & reg_wr;
assign r1_tdes10_rd = (paddr == 32'h40020000 + 8'h90) & reg_rd;
assign r1_tdes11_wr = (paddr == 32'h40020000 + 8'h94) & reg_wr;
assign r1_tdes11_rd = (paddr == 32'h40020000 + 8'h94) & reg_rd;
assign r1_tdes12_wr = (paddr == 32'h40020000 + 8'h98) & reg_wr;
assign r1_tdes12_rd = (paddr == 32'h40020000 + 8'h98) & reg_rd;
assign r1_tdes13_wr = (paddr == 32'h40020000 + 8'h9c) & reg_wr;
assign r1_tdes13_rd = (paddr == 32'h40020000 + 8'h9c) & reg_rd;
assign r1_tdes20_wr = (paddr == 32'h40020000 + 8'ha0) & reg_wr;
assign r1_tdes20_rd = (paddr == 32'h40020000 + 8'ha0) & reg_rd;
assign r1_tdes21_wr = (paddr == 32'h40020000 + 8'ha4) & reg_wr;
assign r1_tdes21_rd = (paddr == 32'h40020000 + 8'ha4) & reg_rd;
assign r1_tdes22_wr = (paddr == 32'h40020000 + 8'ha8) & reg_wr;
assign r1_tdes22_rd = (paddr == 32'h40020000 + 8'ha8) & reg_rd;
assign r1_tdes23_wr = (paddr == 32'h40020000 + 8'hac) & reg_wr;
assign r1_tdes23_rd = (paddr == 32'h40020000 + 8'hac) & reg_rd;
assign r1_tdes30_wr = (paddr == 32'h40020000 + 8'hb0) & reg_wr;
assign r1_tdes30_rd = (paddr == 32'h40020000 + 8'hb0) & reg_rd;
assign r1_tdes31_wr = (paddr == 32'h40020000 + 8'hb4) & reg_wr;
assign r1_tdes31_rd = (paddr == 32'h40020000 + 8'hb4) & reg_rd;
assign r1_tdes32_wr = (paddr == 32'h40020000 + 8'hb8) & reg_wr;
assign r1_tdes32_rd = (paddr == 32'h40020000 + 8'hb8) & reg_rd;
assign r1_tdes33_wr = (paddr == 32'h40020000 + 8'hbc) & reg_wr;
assign r1_tdes33_rd = (paddr == 32'h40020000 + 8'hbc) & reg_rd;
assign r1_rdes00_wr = (paddr == 32'h40020000 + 8'hc0) & reg_wr;
assign r1_rdes00_rd = (paddr == 32'h40020000 + 8'hc0) & reg_rd;
assign r1_rdes01_wr = (paddr == 32'h40020000 + 8'hc4) & reg_wr;
assign r1_rdes01_rd = (paddr == 32'h40020000 + 8'hc4) & reg_rd;
assign r1_rdes02_wr = (paddr == 32'h40020000 + 8'hc8) & reg_wr;
assign r1_rdes02_rd = (paddr == 32'h40020000 + 8'hc8) & reg_rd;
assign r1_rdes03_wr = (paddr == 32'h40020000 + 8'hcc) & reg_wr;
assign r1_rdes03_rd = (paddr == 32'h40020000 + 8'hcc) & reg_rd;
assign r1_rdes10_wr = (paddr == 32'h40020000 + 8'hd0) & reg_wr;
assign r1_rdes10_rd = (paddr == 32'h40020000 + 8'hd0) & reg_rd;
assign r1_rdes11_wr = (paddr == 32'h40020000 + 8'hd4) & reg_wr;
assign r1_rdes11_rd = (paddr == 32'h40020000 + 8'hd4) & reg_rd;
assign r1_rdes12_wr = (paddr == 32'h40020000 + 8'hd8) & reg_wr;
assign r1_rdes12_rd = (paddr == 32'h40020000 + 8'hd8) & reg_rd;
assign r1_rdes13_wr = (paddr == 32'h40020000 + 8'hdc) & reg_wr;
assign r1_rdes13_rd = (paddr == 32'h40020000 + 8'hdc) & reg_rd;
assign r1_rdes20_wr = (paddr == 32'h40020000 + 8'he0) & reg_wr;
assign r1_rdes20_rd = (paddr == 32'h40020000 + 8'he0) & reg_rd;
assign r1_rdes21_wr = (paddr == 32'h40020000 + 8'he4) & reg_wr;
assign r1_rdes21_rd = (paddr == 32'h40020000 + 8'he4) & reg_rd;
assign r1_rdes22_wr = (paddr == 32'h40020000 + 8'he8) & reg_wr;
assign r1_rdes22_rd = (paddr == 32'h40020000 + 8'he8) & reg_rd;
assign r1_rdes23_wr = (paddr == 32'h40020000 + 8'hec) & reg_wr;
assign r1_rdes23_rd = (paddr == 32'h40020000 + 8'hec) & reg_rd;
assign r1_rdes30_wr = (paddr == 32'h40020000 + 8'hf0) & reg_wr;
assign r1_rdes30_rd = (paddr == 32'h40020000 + 8'hf0) & reg_rd;
assign r1_rdes31_wr = (paddr == 32'h40020000 + 8'hf4) & reg_wr;
assign r1_rdes31_rd = (paddr == 32'h40020000 + 8'hf4) & reg_rd;
assign r1_rdes32_wr = (paddr == 32'h40020000 + 8'hf8) & reg_wr;
assign r1_rdes32_rd = (paddr == 32'h40020000 + 8'hf8) & reg_rd;
assign r1_rdes33_wr = (paddr == 32'h40020000 + 8'hfc) & reg_wr;
assign r1_rdes33_rd = (paddr == 32'h40020000 + 8'hfc) & reg_rd;
assign r1_pe_ctrl0_wr = (paddr == 32'h40020000 + 8'h100) & reg_wr;
assign r1_pe_ctrl0_rd = (paddr == 32'h40020000 + 8'h100) & reg_rd;
assign r1_pe_ctrl1_wr = (paddr == 32'h40020000 + 8'h104) & reg_wr;
assign r1_pe_ctrl1_rd = (paddr == 32'h40020000 + 8'h104) & reg_rd;
assign r1_pe_ctrl2_wr = (paddr == 32'h40020000 + 8'h108) & reg_wr;
assign r1_pe_ctrl2_rd = (paddr == 32'h40020000 + 8'h108) & reg_rd;
assign r1_pe_ctrl3_wr = (paddr == 32'h40020000 + 8'h10c) & reg_wr;
assign r1_pe_ctrl3_rd = (paddr == 32'h40020000 + 8'h10c) & reg_rd;
assign r1_int0_en_wr = (paddr == 32'h40020000 + 8'h120) & reg_wr;
assign r1_int0_en_rd = (paddr == 32'h40020000 + 8'h120) & reg_rd;
assign r1_int1_en_wr = (paddr == 32'h40020000 + 8'h124) & reg_wr;
assign r1_int1_en_rd = (paddr == 32'h40020000 + 8'h124) & reg_rd;
assign r1_int2_en_wr = (paddr == 32'h40020000 + 8'h128) & reg_wr;
assign r1_int2_en_rd = (paddr == 32'h40020000 + 8'h128) & reg_rd;
assign r1_int0_clr_wr = (paddr == 32'h40020000 + 8'h130) & reg_wr;
assign r1_int0_clr_rd = (paddr == 32'h40020000 + 8'h130) & reg_rd;
assign r1_int1_clr_wr = (paddr == 32'h40020000 + 8'h134) & reg_wr;
assign r1_int1_clr_rd = (paddr == 32'h40020000 + 8'h134) & reg_rd;
assign r1_int2_clr_wr = (paddr == 32'h40020000 + 8'h138) & reg_wr;
assign r1_int2_clr_rd = (paddr == 32'h40020000 + 8'h138) & reg_rd;
assign r1_int0_sta_wr = (paddr == 32'h40020000 + 8'h140) & reg_wr;
assign r1_int0_sta_rd = (paddr == 32'h40020000 + 8'h140) & reg_rd;
assign r1_int1_sta_wr = (paddr == 32'h40020000 + 8'h144) & reg_wr;
assign r1_int1_sta_rd = (paddr == 32'h40020000 + 8'h144) & reg_rd;
assign r1_int2_sta_wr = (paddr == 32'h40020000 + 8'h148) & reg_wr;
assign r1_int2_sta_rd = (paddr == 32'h40020000 + 8'h148) & reg_rd;
...
always@(*) begin
    case(paddr)
        ...
        32'h40020000 + 8'h30 : prdata = R1_TOP_CTRL;
        32'h40020000 + 8'h34 : prdata = R1_DMA_CTRL0;
        32'h40020000 + 8'h40 : prdata = R1_DMA_TDES0;
        32'h40020000 + 8'h44 : prdata = R1_DMA_TDES1;
        32'h40020000 + 8'h48 : prdata = R1_DMA_TDES2;
        32'h40020000 + 8'h50 : prdata = R1_DMA_RDES0;
        32'h40020000 + 8'h54 : prdata = R1_DMA_RDES1;
        32'h40020000 + 8'h58 : prdata = R1_DMA_RDES2;
        32'h40020000 + 8'h80 : prdata = R1_TDES00 ;
        32'h40020000 + 8'h84 : prdata = R1_TDES01 ;
        32'h40020000 + 8'h88 : prdata = R1_TDES02 ;
        32'h40020000 + 8'h8c : prdata = R1_TDES03 ;
        32'h40020000 + 8'h90 : prdata = R1_TDES10 ;
        32'h40020000 + 8'h94 : prdata = R1_TDES11 ;
        32'h40020000 + 8'h98 : prdata = R1_TDES12 ;
        32'h40020000 + 8'h9c : prdata = R1_TDES13 ;
        32'h40020000 + 8'ha0 : prdata = R1_TDES20 ;
        32'h40020000 + 8'ha4 : prdata = R1_TDES21 ;
        32'h40020000 + 8'ha8 : prdata = R1_TDES22 ;
        32'h40020000 + 8'hac : prdata = R1_TDES23 ;
        32'h40020000 + 8'hb0 : prdata = R1_TDES30 ;
        32'h40020000 + 8'hb4 : prdata = R1_TDES31 ;
        32'h40020000 + 8'hb8 : prdata = R1_TDES32 ;
        32'h40020000 + 8'hbc : prdata = R1_TDES33 ;
        32'h40020000 + 8'hc0 : prdata = R1_RDES00 ;
        32'h40020000 + 8'hc4 : prdata = R1_RDES01 ;
        32'h40020000 + 8'hc8 : prdata = R1_RDES02 ;
        32'h40020000 + 8'hcc : prdata = R1_RDES03 ;
        32'h40020000 + 8'hd0 : prdata = R1_RDES10 ;
        32'h40020000 + 8'hd4 : prdata = R1_RDES11 ;
        32'h40020000 + 8'hd8 : prdata = R1_RDES12 ;
        32'h40020000 + 8'hdc : prdata = R1_RDES13 ;
        32'h40020000 + 8'he0 : prdata = R1_RDES20 ;
        32'h40020000 + 8'he4 : prdata = R1_RDES21 ;
        32'h40020000 + 8'he8 : prdata = R1_RDES22 ;
        32'h40020000 + 8'hec : prdata = R1_RDES23 ;
        32'h40020000 + 8'hf0 : prdata = R1_RDES30 ;
        32'h40020000 + 8'hf4 : prdata = R1_RDES31 ;
        32'h40020000 + 8'hf8 : prdata = R1_RDES32 ;
        32'h40020000 + 8'hfc : prdata = R1_RDES33 ;
        32'h40020000 + 8'h100 : prdata = R1_PE_CTRL0;
        32'h40020000 + 8'h104 : prdata = R1_PE_CTRL1;
        32'h40020000 + 8'h108 : prdata = R1_PE_CTRL2;
        32'h40020000 + 8'h10c : prdata = R1_PE_CTRL3;
        32'h40020000 + 8'h120 : prdata = R1_INT0_EN;
        32'h40020000 + 8'h124 : prdata = R1_INT1_EN;
        32'h40020000 + 8'h128 : prdata = R1_INT2_EN;
        32'h40020000 + 8'h130 : prdata = R1_INT0_CLR;
        32'h40020000 + 8'h134 : prdata = R1_INT1_CLR;
        32'h40020000 + 8'h138 : prdata = R1_INT2_CLR;
        32'h40020000 + 8'h140 : prdata = R1_INT0_STA;
        32'h40020000 + 8'h144 : prdata = R1_INT1_STA;
        32'h40020000 + 8'h148 : prdata = R1_INT2_STA;
