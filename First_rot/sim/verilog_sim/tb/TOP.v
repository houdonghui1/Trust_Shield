...
begin
	...
	$fsdbDumpvars(0, TOP);
	$fsdbDumpvars(0, u_mcu_top.u_fp_domain.u_apb3_caliptra_sync.caliptra_top_dut.security_state);
	$fsdbDumpvars(0, u_mcu_top.u_fp_domain.u_apb3_caliptra_sync.caliptra_top_dut.spi_host.alert_rx_i);
	$fsdbDumpvars(0, u_mcu_top.u_fp_domain.u_apb3_caliptra_sync.caliptra_top_dut.spi_host.alert_tx_o);
	$fsdbDumpMDA();
end
`endif
