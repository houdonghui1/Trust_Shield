...
//	end	
	for(int i = 0; i < 32'h10; i = i + 4)
	begin: FW_STORE_WR_TEST_S
		u_swd_model.swd_writereg32(32'h00040000 + i, i);
		u_swd_model.swd_readreg32(32'h00040000 + i, rdata);
		u_swd_model.swd_readreg32(32'h00040000 + i, rdata);
		u_sim_monitor.sim_monitor_check_with_display((32'h00040000 + i), rdata, i);
	end	

	for(int i = 0; i < 32'h10; i = i + 4)
	begin: FW_STORE_WR_TEST_E
		u_swd_model.swd_writereg32(32'h0006FFF0 + i, i);
		u_swd_model.swd_readreg32(32'h0006FFF0 + i, rdata);
		u_swd_model.swd_readreg32(32'h0006FFF0 + i, rdata);
		u_sim_monitor.sim_monitor_check_with_display((32'h0006FFF0 + i), rdata, i);
	end	
