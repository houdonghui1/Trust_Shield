...
//     TODO:
//     This header file includes static inline function definitions for event and
...
// These static inline functions are used to insert event-specific functionality into the
// otherwise generic ISR that gets laid down by the parameterized macro "nonstd_veer_isr"
static inline void service_doe_error_intr() {
    printf("DOE error interrupt triggered\n");
    return;}
static inline void service_doe_notif_intr() {
    ...
    if (sts == 0) {
        printf("bad doe_notif_intr sts:%lx\n", sts);
        while(1);
    }
}

static inline void service_ecc_error_intr() {
     printf("ECC error interrupt triggered\n");
     return;}
static inline void service_ecc_notif_intr() {
    ...
    if (sts == 0) {
        printf("bad ecc_notif_intr sts:%lx\n", sts);
        while(1);
    }
}

static inline void service_hmac_error_intr() {return;}
static inline void service_hmac_notif_intr() {
    ...
    if (sts == 0) {
        printf("bad hmac_notif_intr sts:%lx\n", sts);
        while(1);
    }
}

static inline void service_kv_error_intr() {return;}
static inline void service_kv_notif_intr() {return;}
static inline void service_sha512_error_intr() {return;}
static inline void service_sha512_notif_intr() {
    ...
    if (sts == 0) {
        printf("bad sha512_notif_intr sts:%lx\n", sts);
        while(1);
    }
}

static inline void service_sha256_error_intr() {return;}
static inline void service_sha256_notif_intr() {
    ...
    if (sts == 0) {
        printf("bad sha256_notif_intr sts:%lx\n", sts);
        while(1);
    }
}

static inline void service_qspi_error_intr() {return;}
static inline void service_qspi_notif_intr() {return;}
static inline void service_uart_error_intr() {return;}
static inline void service_uart_notif_intr() {return;}
static inline void service_i3c_error_intr() {return;}
static inline void service_i3c_notif_intr() {return;}

static inline void service_soc_ifc_error_intr() {
    ...
    if (sts == 0) {
        printf("bad soc_ifc_error_intr sts:%lx\n", sts);
        while(1);
    }
}

static inline void service_soc_ifc_notif_intr () {
    ...
    if (sts == 0) {
        printf("bad soc_ifc_notif_intr sts:%lx\n", sts);
        while(1);
    }
}

static inline void service_sha512_acc_error_intr() {return;}
static inline void service_sha512_acc_notif_intr() {
    ...
    if (sts == 0) {
        printf("bad sha512_acc_notif_intr sts:%lx\n", sts);
        while(1);
    }
}
