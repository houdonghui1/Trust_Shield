...
module apb3_caliptra(
    input						apb3_root_clk,
	(*mark_debug="true"*)(*keep="true"*)input						apb3_root_rstn,

    (*mark_debug="true"*)(*keep="true"*)input	[31:0]				paddr,  
	input						penable,
	input	[ 3:0]				pstrb,  
	input	[ 2:0]				pprot,  
	input						pwrite, 
    ...
    //QSPI Interface
    (*mark_debug="true"*)(*keep="true"*)output logic                                ca_qspi_clk,
    (*mark_debug="true"*)(*keep="true"*)output logic                                ca_qspi_cs,
                                        inout wire [`CALIPTRA_QSPI_IO_WIDTH-1:0]    ca_qspi_data,
    //uart export
    output                                 ca_uart_tx,
    input                                  ca_uart_rx,

    (*mark_debug="true"*)(*keep="true"*)input   [2:0]               security_state,
    (*mark_debug="true"*)(*keep="true"*)input                       scan_mode,
    (*mark_debug="true"*)(*keep="true"*)input                       BootFSM_BrkPoint,

    (*mark_debug="true"*)(*keep="true"*)output                                 cptra_error_fatal,
    (*mark_debug="true"*)(*keep="true"*)output                                 cptra_error_non_fatal
);

//上电信号的处理
(*mark_debug="true"*)(*keep="true"*)wire pwrgood_15_high;
...
//SPI
(*mark_debug="true"*)logic [`CALIPTRA_QSPI_IO_WIDTH-1:0]  qspi_data_host_to_device, qspi_data_device_to_host;
(*mark_debug="true"*)logic [`CALIPTRA_QSPI_IO_WIDTH-1:0]  qspi_data_host_to_device_en;

// Physical Source for Internal TRNG

(*mark_debug="true"*)logic             etrng_req;
(*mark_debug="true"*)logic [3:0]       itrng_data;
(*mark_debug="true"*)logic             itrng_valid;
