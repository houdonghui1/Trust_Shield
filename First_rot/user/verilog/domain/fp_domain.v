...
// apb3 sync
wire							hsel_apb3;
wire	[31:0]				 	haddr_apb3; 
wire	[ 1:0]				 	htrans_apb3; 
wire	[ 2:0]				 	hsize_apb3; 
wire	      					hwrite_apb3; 
wire	[ 2:0]					hburst_apb3; 
wire	[ 3:0]				 	hprot_apb3; 
wire	      					hmastlock_apb3; 
wire	[ 1:0]					hmemattr_apb3;
wire	[ 3:0]					hmaster_apb3;
wire	[31:0]				 	hwdata_apb3; 
wire	      					hexreq_apb3;
wire	      					hready_apb3; 
wire	[31:0]				 	hrdata_apb3; 
wire	      					hreadyout_apb3; 
wire	[ 1:0]				 	hresp_apb3;
wire	      					hexresp_apb3;
...
(
	...
	.HBURSTM2					(hburst_fw),
	.HPROTM2					(hprot_fw),
	.HMASTERM2					(hmaster_fw),
	.HWDATAM2					(hwdata_fw),
	.HMASTLOCKM2				(hmastlock_fw),
	.HREADYMUXM2				(hready_fw),
	.HAUSERM2					(),
	.HWUSERM2					(),
	.HRDATAM2					(hrdata_fw),
	.HREADYOUTM2				(hreadyout_fw),
	.HRESPM2					(hresp_fw),
	.HRUSERM2					(32'b0),
...
//	.HRUSERM5					(32'b0),
	...
	.HSELM9						(hsel_apb3),
	.HADDRM9					(haddr_apb3),
	.HTRANSM9					(htrans_apb3),
	.HWRITEM9					(hwrite_apb3),
	.HSIZEM9					(hsize_apb3),
	.HBURSTM9					(hburst_apb3),
	.HPROTM9					(hprot_apb3),
	.HMASTERM9					(hmaster_apb3),
	.HWDATAM9					(hwdata_apb3),
	.HMASTLOCKM9				(hmastlock_apb3),
	.HREADYMUXM9				(hready_apb3),
	.HAUSERM9					(),
	.HWUSERM9					(),
	.HRDATAM9					(hrdata_apb3),
	.HREADYOUTM9				(hreadyout_apb3),
	.HRESPM9					(hresp_apb3),
	.HRUSERM9					(32'b0),
...
//===============================================
// fw_store_top
// 0x00040000~0x0006ffff
//===============================================
fw_store_top u_fw_store_top
(
	.sys_root_clk				(sys_root_clk),
	.sys_root_rstn				(sys_root_rstn),
...
apb3_caliptra u_apb3_caliptra_sync(
	
	.apb3_root_clk				(apb3_root_clk),
	.apb3_root_rstn				(apb3_root_rstn),
    ...
    .ca_jtag_tck				(ca_jtag_tck),    // JTAG clk
    .ca_jtag_tms				(ca_jtag_tms),    // JTAG TMS
    .ca_jtag_tdi				(ca_jtag_tdi),    // JTAG tdi
    .ca_jtag_trst_n				(ca_jtag_trst_n), // JTAG Reset
    .ca_jtag_tdo				(ca_jtag_tdo),    // JTAG TDO
