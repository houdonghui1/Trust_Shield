...
#define writereg32(addr, data)					(*(volatile uint32_t *)(uintptr_t)(addr) = data)
#define writereg16(addr, data)					(*(volatile uint16_t *)(uintptr_t)(addr) = data)
#define writereg8(addr, data)					(*(volatile uint8_t *)(uintptr_t)(addr) = data)
#define readreg32(addr)							(*(volatile uint32_t *)(uintptr_t)(addr))
#define readreg16(addr)							(*(volatile uint16_t *)(uintptr_t)(addr))
#define readreg8(addr)							(*(volatile uint8_t *)(uintptr_t)(addr))
