...
module AsyncResetRegVec_w14_i0(	// @[generators/rocket-chip/src/main/scala/util/AsyncResetReg.scala:56:7]
  ...
  input  [13:0] io_d,	// @[generators/rocket-chip/src/main/scala/util/AsyncResetReg.scala:59:14]
  output [13:0] io_q,	// @[generators/rocket-chip/src/main/scala/util/AsyncResetReg.scala:59:14]
  input         io_en	// @[generators/rocket-chip/src/main/scala/util/AsyncResetReg.scala:59:14]
);

  reg [13:0] reg_0;	// @[generators/rocket-chip/src/main/scala/util/AsyncResetReg.scala:61:50]
  always @(posedge clock or posedge reset) begin	// @[generators/rocket-chip/src/main/scala/util/AsyncResetReg.scala:56:7]
    if (reset)	// @[generators/rocket-chip/src/main/scala/util/AsyncResetReg.scala:56:7]
      reg_0 <= 14'h0;	// @[generators/rocket-chip/src/main/scala/util/AsyncResetReg.scala:61:50]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip/src/main/scala/util/AsyncResetReg.scala:56:7]
    ...
    initial begin	// @[generators/rocket-chip/src/main/scala/util/AsyncResetReg.scala:56:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip/src/main/scala/util/AsyncResetReg.scala:56:7]
        ...
        reg_0 = _RANDOM[/*Zero width*/ 1'b0][13:0];	// @[generators/rocket-chip/src/main/scala/util/AsyncResetReg.scala:56:7, :61:50]
      `endif // RANDOMIZE_REG_INIT
      if (reset)	// @[generators/rocket-chip/src/main/scala/util/AsyncResetReg.scala:56:7]
        reg_0 = 14'h0;	// @[generators/rocket-chip/src/main/scala/util/AsyncResetReg.scala:61:50]
    end // initial
