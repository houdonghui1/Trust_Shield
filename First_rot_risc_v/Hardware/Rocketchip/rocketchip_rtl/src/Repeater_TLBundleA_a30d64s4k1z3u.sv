...
module Repeater_TLBundleA_a30d64s4k1z3u(	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7]
  ...
  input  [29:0] io_enq_bits_address,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:13:14]
  ...
  output [29:0] io_deq_bits_address,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:13:14]
  ...
  reg  [29:0] saved_address;	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:21:18]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7]
    ...
    initial begin	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7]
        ...
        saved_address = {_RANDOM[2'h0][31:14], _RANDOM[2'h1][11:0]};	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7, :20:21, :21:18]
        saved_user_amba_prot_bufferable = _RANDOM[2'h1][12];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7, :21:18]
        saved_user_amba_prot_modifiable = _RANDOM[2'h1][13];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7, :21:18]
        saved_user_amba_prot_readalloc = _RANDOM[2'h1][14];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7, :21:18]
        saved_user_amba_prot_writealloc = _RANDOM[2'h1][15];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7, :21:18]
        saved_user_amba_prot_privileged = _RANDOM[2'h1][16];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7, :21:18]
        saved_user_amba_prot_secure = _RANDOM[2'h1][17];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7, :21:18]
        saved_user_amba_prot_fetch = _RANDOM[2'h1][18];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7, :21:18]
        saved_mask = _RANDOM[2'h1][26:19];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7, :21:18]
        saved_data = {_RANDOM[2'h1][31:27], _RANDOM[2'h2], _RANDOM[2'h3][26:0]};	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7, :21:18]
        saved_corrupt = _RANDOM[2'h3][27];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7, :21:18]
      `endif // RANDOMIZE_REG_INIT
    end // initial
