...
module SBToTL(	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:273:9]
  ...
  wire [109:0]    _GEN_4 = {io_addrIn[127:28], io_addrIn[27:18] ^ 10'h200};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:137:{31,41,46}]
  ...
  wire [109:0]    _GEN_6 = {io_addrIn[127:30], io_addrIn[29:18] ^ 12'hC00};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:137:{31,41,46}]
  wire [114:0]    _GEN_7 = {io_addrIn[127:31], io_addrIn[30:13] ^ 18'h32000};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:137:{31,41,46}]
  wire [96:0]     _GEN_8 = {io_addrIn[127:32], ~(io_addrIn[31])};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:137:{31,41,46}]
  wire            io_rdLegal_0 = ~(|(io_addrIn[127:13])) | ~(|_GEN_0) | {io_addrIn[127:17], ~(io_addrIn[16])} == 112'h0 | ~(|_GEN_1) | ~(|_GEN_2) | ~(|_GEN_3) | ~(|_GEN_4) | ~(|_GEN_5) | ~(|_GEN_6) | ~(|_GEN_7) | ~(|_GEN_8);	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:274:16, generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:137:{31,41,46,59}, generators/rocket-chip/src/main/scala/tilelink/Parameters.scala:685:42]
  wire            io_wrLegal_0 = ~(|(io_addrIn[127:13])) | ~(|_GEN_0) | ~(|_GEN_1) | ~(|_GEN_2) | ~(|_GEN_3) | ~(|_GEN_4) | ~(|_GEN_5) | ~(|_GEN_6) | ~(|_GEN_7) | ~(|_GEN_8);	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:274:16, generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:137:{41,46,59}, generators/rocket-chip/src/main/scala/tilelink/Parameters.scala:685:42]
  ...
  `ifndef SYNTHESIS	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:373:12]
    always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:373:12]
      if (~reset & ~(_GEN_9 | _nodeOut_a_valid_T | _nodeOut_a_valid_T_1 | _rdTxValid_T | _io_wrDone_T)) begin	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:299:{25,62}, :322:18, :338:29, :349:19, :373:{12,35}, :374:44, :375:45, :376:45]
