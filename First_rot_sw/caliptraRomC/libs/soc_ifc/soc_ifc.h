...
enum mbox_cmd_e {
    ...
    MBOX_CMD_GET_ROM_MEASURE_VALUE = 0x44C0FFF9,
    MBOX_CMD_INITIATE = 0x44C0FFFA,
    MBOX_CMD_RECV_CLP_CSR = 0x44C0FFFB,
    MBOX_CMD_RECV_CLP_CTX = 0x44C0FFFC,
    /* Cluster-BLS L1 enrolment and proof commands. */
