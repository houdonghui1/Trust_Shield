...
`ifdef RV_BUILD_AHB_LITE
 //// AHB LITE BUS
   ...
   // LSU AHB Master
   (*mark_debug="true"*)(*keep="true"*)output logic [31:0]                     lsu_haddr,
   (*mark_debug="true"*)(*keep="true"*)output logic [2:0]                      lsu_hburst,
   (*mark_debug="true"*)(*keep="true"*)output logic                            lsu_hmastlock,
   (*mark_debug="true"*)(*keep="true"*)output logic [3:0]                      lsu_hprot,
   (*mark_debug="true"*)(*keep="true"*)output logic [2:0]                      lsu_hsize,
   (*mark_debug="true"*)(*keep="true"*)output logic [1:0]                      lsu_htrans,
   (*mark_debug="true"*)(*keep="true"*)output logic                            lsu_hwrite,
   (*mark_debug="true"*)(*keep="true"*)output logic [63:0]                     lsu_hwdata,

   (*mark_debug="true"*)(*keep="true"*)input logic [63:0]                      lsu_hrdata,
   (*mark_debug="true"*)(*keep="true"*)input logic                             lsu_hready,
