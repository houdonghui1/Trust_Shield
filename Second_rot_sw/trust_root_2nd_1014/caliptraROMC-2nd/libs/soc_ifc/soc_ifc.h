...
enum mbox_cmd_e {
    ...
    MBOX_CMD_VERIFY_CERT = 0x44C0FFEE,
    MBOX_CMD_GET_CA_CERT = 0x44C0FFEF,
    MBOX_CMD_GET_LDEVID_CERT = 0x44C0FFF0,
    MBOX_CMD_GET_FMC_CERT = 0x44C0FFF1,
    MBOX_CMD_GET_RT_CERT = 0x44C0FFF2,
    MBOX_CMD_GET_TRNG = 0x44C0FFF3,
    MBOX_CMD_GET_SOC_MEASURE_VALUE = 0x44C0FFF4,
    MBOX_CMD_GET_FMC_MEASURE_VALUE = 0x44C0FFF5,
    MBOX_CMD_GET_RT_MEASURE_VALUE = 0x44C0FFF6,
    MBOX_CMD_ECC_SIGN = 0x44C0FFF7,
    MBOX_CMD_ECC_VERIFY = 0x44C0FFF8,
    MBOX_CMD_GENERATE_2ND_CERT = 0x44C0FFF9,
    MBOX_CMD_SAVE_2ND_CERT = 0x44C0FFFA,
    MBOX_CMD_GET_2ND_CERT = 0x44C0FFFB,
    MBOX_CMD_SIGN_1ST_CTX = 0x44C0FFFC,
    MBOX_CMD_VERIFY_1ST_CTX = 0x44C0FFFD,
    /* Cluster-BLS (PoP ciphersuite) enrollment and proof commands. */
    MBOX_CMD_BLS_GET_REGISTRATION      = 0x44C0FFE0,
    MBOX_CMD_BLS_REGISTER_L1          = 0x44C0FFE1,
    MBOX_CMD_BLS_REVOKE_L1            = 0x44C0FFE2,
    MBOX_CMD_BLS_SIGN_CHALLENGE       = 0x44C0FFE3,
    MBOX_CMD_BLS_AGGREGATE_CHALLENGE  = 0x44C0FFE4,
    MBOX_CMD_BLS_SIGN_L1_CERT         = 0x44C0FFE5,
    MBOX_CMD_RECV_SOC_FW = 0x1A2B3C4D
};
...
static inline void soc_ifc_mbox_dir_write_single(uint32_t wrptr, uint32_t wrdata) {
...
static inline void soc_ifc_sha_accel_execute() {
