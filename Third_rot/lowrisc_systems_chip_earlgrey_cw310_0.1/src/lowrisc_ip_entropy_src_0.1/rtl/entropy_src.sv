...
#(
  ...
  // RNG Interface
  output entropy_src_rng_req_t entropy_src_rng_out_en_o,
  input  entropy_src_rng_rsp_t puf_entropy_src_rng_i,
  ...
  assign entropy_src_rng_out_en_o     = Stub ? '1                 : core_rng;
  ...
  entropy_src_core #(
    ...
    .entropy_src_rng_i(puf_entropy_src_rng_i),
  ...
  // RNG Interface
  `ASSERT_KNOWN(EsRngEnableKnownO_A, entropy_src_rng_out_en_o.rng_enable)
