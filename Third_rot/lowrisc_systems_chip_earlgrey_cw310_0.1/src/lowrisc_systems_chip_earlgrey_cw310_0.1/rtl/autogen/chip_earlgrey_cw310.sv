...
module chip_earlgrey_cw310 #(
  ...
  parameter BootRomInitFile = "/home/houdonghui/memroy/test_rom_fpga_cw310.39.scr.vmem",
  // Path to a VMEM file containing the contents of the emulated OTP, which will be
  // baked into the FPGA bitstream.
  parameter OtpCtrlMemInitFile = "/home/houdonghui/memroy/img_rma.24.vmem"
) (
  // Dedicated Pads
