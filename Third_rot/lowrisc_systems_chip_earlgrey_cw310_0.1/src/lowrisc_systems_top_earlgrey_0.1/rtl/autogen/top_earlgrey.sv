...
module top_earlgrey #(
  ...
  sm4_pkg::sm4_result_req_t       sm4_result_puf;
  entropy_src_pkg::entropy_src_rng_rsp_t       puf_entropy_src_rng;
...
// pragma coverage on
  ...
  puf u_puf (
      ...
      // Inter-module signals
      .entropy_src_rng_o(puf_entropy_src_rng),
      .sm4_result_i(sm4_result_puf),
      .tl_i(puf_tl_req),
      .tl_o(puf_tl_rsp),
  ...
  entropy_src #(
    ...
    .Stub(EntropySrcStub)
      ...
      .puf_entropy_src_rng_i(puf_entropy_src_rng),
      .entropy_src_rng_out_en_o(),
      .entropy_src_xht_o(),
