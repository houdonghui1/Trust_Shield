...
package top_earlgrey_pkg;
   ...
   */
  parameter int unsigned TOP_EARLGREY_PUF_BASE_ADDR = 32'h42008000;

  /**
   * Peripheral size in bytes for puf in top earlgrey.
   */
  parameter int unsigned TOP_EARLGREY_PUF_SIZE_BYTES = 32'h40;

  /**
   * Peripheral base address for rs_decode in top earlgrey.
   */
  parameter int unsigned TOP_EARLGREY_RS_DECODE_BASE_ADDR = 32'h42006000;
   ...
   */
  parameter int unsigned TOP_EARLGREY_RS_ENCODE_BASE_ADDR = 32'h42004000;
   ...
   */
  parameter int unsigned TOP_EARLGREY_SM3_BASE_ADDR = 32'h42002000;
   ...
   */
  parameter int unsigned TOP_EARLGREY_SM4_BASE_ADDR = 32'h42000000;
