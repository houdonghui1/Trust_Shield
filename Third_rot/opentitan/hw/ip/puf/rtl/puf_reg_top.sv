...
module puf_reg_top (
  ...
  logic state_signals_response_done_4bit_qs;
  ...
  //   F[response_done_4bit]: 1:1
  prim_subreg #(
    .DW      (1),
    .SwAccess(prim_subreg_pkg::SwAccessRO),
    .RESVAL  (1'h0),
    .Mubi    (1'b0)
  ) u_state_signals_response_done_4bit (
    .clk_i   (clk_i),
    .rst_ni  (rst_ni),
    ...
    // from internal hardware
    .de     (hw2reg.state_signals.response_done_4bit.de),
    .d      (hw2reg.state_signals.response_done_4bit.d),

    // to internal hardware
    .qe     (),
    .q      (reg2hw.state_signals.response_done_4bit.q),
    .ds     (),

    // to register interface (read)
    .qs     (state_signals_response_done_4bit_qs)
  );
  ...
  always_comb begin
    ...
    unique case (1'b1)
      ...
      addr_hit[1]: begin
        ...
        reg_rdata_next[1] = state_signals_response_done_4bit_qs;
      end
