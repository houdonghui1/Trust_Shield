...
(
  ...
  //inter modules
  output sm4_result_req_t                           result_puf_o
);

  sm4_reg2hw_t               reg2hw;
  sm4_hw2reg_t               hw2reg;
  //wire                       ready_out;
assign result_puf_o.valid_out = hw2reg.state_signals.valid_out.d;
assign result_puf_o.sm4_result = {hw2reg.result_out[3].d,hw2reg.result_out[2].d,hw2reg.result_out[1].d,hw2reg.result_out[0].d};
