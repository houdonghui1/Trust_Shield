...
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const PUF_BASE_ADDR: usize = 0x42008000;

/// Peripheral size for puf in top earlgrey.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
/// address between #PUF_BASE_ADDR and
/// `PUF_BASE_ADDR + PUF_SIZE_BYTES`.
pub const PUF_SIZE_BYTES: usize = 0x40;

/// Peripheral base address for rs_decode in top earlgrey.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const RS_DECODE_BASE_ADDR: usize = 0x42006000;
...
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const RS_ENCODE_BASE_ADDR: usize = 0x42004000;
...
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const SM3_BASE_ADDR: usize = 0x42002000;
...
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const SM4_BASE_ADDR: usize = 0x42000000;
