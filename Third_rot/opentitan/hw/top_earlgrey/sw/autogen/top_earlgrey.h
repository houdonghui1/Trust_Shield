 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EARLGREY_PUF_BASE_ADDR 0x42008000u
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EARLGREY_RS_DECODE_BASE_ADDR 0x42006000u
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EARLGREY_RS_ENCODE_BASE_ADDR 0x42004000u
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EARLGREY_SM3_BASE_ADDR 0x42002000u
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EARLGREY_SM4_BASE_ADDR 0x42000000u
