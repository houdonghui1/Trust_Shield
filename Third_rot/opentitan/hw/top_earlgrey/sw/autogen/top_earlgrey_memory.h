 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EARLGREY_PUF_BASE_ADDR 0x42008000
 ...
 */
#define TOP_EARLGREY_PUF_SIZE_BYTES 0x40
/**
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EARLGREY_RS_DECODE_BASE_ADDR 0x42006000
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EARLGREY_RS_ENCODE_BASE_ADDR 0x42004000
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EARLGREY_SM3_BASE_ADDR 0x42002000
 ...
 * registers associated with the peripheral (usually via a DIF).
 */
#define TOP_EARLGREY_SM4_BASE_ADDR 0x42000000
