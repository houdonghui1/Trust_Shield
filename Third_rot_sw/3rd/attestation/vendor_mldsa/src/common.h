...
#ifdef MLD_CONFIG_CUSTOM_ZEROIZE
#include <string.h>
...
#ifndef MLD_ALIGN
#define MLD_ALIGN __attribute__((aligned(8)))
#endif

#ifndef MLD_ALIGN_UP
#define MLD_ALIGN_UP_2(x, align) (((x) + (align) - 1) & ~((align) - 1))
#define MLD_ALIGN_UP_1(x) MLD_ALIGN_UP_2(x, 8)
#define MLD_ALIGN_UP(...) \
    _MLD_ALIGN_UP_CHOOSER(__VA_ARGS__, MLD_ALIGN_UP_2, MLD_ALIGN_UP_1)(__VA_ARGS__)
#define _MLD_ALIGN_UP_CHOOSER(_1, _2, CHOICE, ...) CHOICE
#endif
