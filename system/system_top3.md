...
<div align="center">
<img src="./system_top3_drawio/01.png" alt="alt" width="70%" />
</div>
...
<div align="center">
<img src="./system_top3_drawio/02.png" alt="alt" width="70%" />
</div>
...
<div align="center">
<img src="./system_top3_drawio/03.png" alt="alt" width="70%" />
</div>
...
**ML-DSA后量子签名集成**：三级可信根在远程证明的Quote包中，使用ML-DSA-87（NIST Level 5）对Nonce和PCR拼接后的摘要进行签名。AK证书的X.509自定义扩展字段（OID: 1.3.6.1.4.1.311.21.99）中嵌入2592字节的ML-DSA公钥，实现设备身份与抗量子密钥的绑定。
